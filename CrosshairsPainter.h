#ifndef CROSSHAIRSPAINTER_H
#define CROSSHAIRSPAINTER_H

#include <QVideoWidget>
#include <QPainter>
#include <QEvent>

class CrossHairsPainter : public QObject {
public:
    explicit CrossHairsPainter(QVideoWidget *videoWidget) : QObject(videoWidget), videoWidget(videoWidget) {
